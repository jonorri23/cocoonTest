...
import SceneV5 from '../components/SceneV5';
            ...
            {!showIntro && (
                <>
                    <div className="canvas-container">
                        <Canvas key="v5-canvas" dpr={[1, 2]}>
                            <Suspense fallback={null}>
                                <SceneV5 onNavigationChange={setNavigationPath} />
                            </Suspense>
                        </Canvas>
                    </div>
                    ...
                    <div className="ui-layer">
                        ...
                        >
                            Cocoon <span style={{ fontSize: '1rem', opacity: 0.5 }}>V5</span>
                        </motion.h1>
