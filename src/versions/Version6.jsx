...
import IntroAnimationV6 from '../components/IntroAnimationV6';
import SceneV6 from '../components/SceneV6';
            ...
            {!showIntro && (
                <>
                    <div className="canvas-container">
                        <Canvas key="v6-canvas" dpr={[1, 2]}>
                            <Suspense fallback={null}>
                                <SceneV6 onNavigationChange={setNavigationPath} />
                            </Suspense>
                        </Canvas>
                    </div>
                    ...
                    <div className="ui-layer">
                        ...
                        >
                            Cocoon <span style={{ fontSize: '1rem', opacity: 0.5 }}>V6</span>
                        </motion.h1>
