...
import IntroAnimationV8 from '../components/IntroAnimationV8';
import SceneV8 from '../components/SceneV8';
            ...
            {!showIntro && (
                <>
                    <div className="canvas-container">
                        <Canvas key="v8-canvas" dpr={[1, 2]}>
                            <Suspense fallback={null}>
                                <SceneV8 onNavigationChange={setNavigationPath} />
                            </Suspense>
                        </Canvas>
                    </div>
                    ...
                    <div className="ui-layer">
                        ...
                        >
                            Cocoon <span style={{ fontSize: '1rem', opacity: 0.5 }}>V8</span>
                        </motion.h1>
